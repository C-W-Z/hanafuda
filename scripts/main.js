...
window.onload = function()
{
    ...
    /* Card Imgs */
    const loadingOrder = [48,0,8,28,40,44,4,12,16,20,24,32,36,1,2,3,5,6,7,9,10,11,13,14,15,17,18,19,21,22,23,25,26,27,29,30,31,33,34,35,37,38,39,41,42,43,45,46,47];
    for (let i = 0; i < CARD_NUM+1; i++) {
        cardImg[loadingOrder[i]].onload = redraw_canvas;
        cardImg[loadingOrder[i]].src = `imgs/${loadingOrder[i]}.webp`;
    }
    init_game();
